...
var isEnv = function (x) { return isEmptyEnv(x) || isExtEnv(x) || isRecEnv(x); };
// Apply-env
...
var applyRecEnv = function (env, v) {
    return env.vars.includes(v) ? L4_value_1.makeClosure4(env.paramss[env.vars.indexOf(v)], env.bodiess[env.vars.indexOf(v)], env) :
        exports.applyEnv(env.nextEnv, v);
};
//# sourceMappingURL=L4-env.js.map