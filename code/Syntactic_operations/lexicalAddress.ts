...
import { BoolExp, LitExp, NumExp, StrExp, VarDecl, VarRef } from '../AST_Definitions/L3-ast';
import { isBoolExp, isLitExp, isNumExp, isStrExp, isVarRef } from '../AST_Definitions/L3-ast';
import { makeBoolExp, makeLitExp, makeNumExp, makeStrExp, makeVarDecl, makeVarRef } from '../AST_Definitions/L3-ast';
import { isArray, isBoolean, isEmpty, isNumber, isNumericString, isSexpString, isString } from '../AST_Definitions/L3-ast';
import { parseLitExp } from '../AST_Definitions/L3-ast';
import { isError, safeF, safeFL } from '../Support_functions/error';
...
import { SExp } from '../Syntactic_operations/L3-values';
import { isCompoundSExp, isEmptySExp, isSymbolSExp } from '../Syntactic_operations/L3-values';
